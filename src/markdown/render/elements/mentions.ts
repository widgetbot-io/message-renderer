  ...
  ${inline
    ...
    : css`
        ...
        background-color: ${Color(color)
          ...
          .string()};
        color: ${color === THEME_COLOR_ACCENT
...
export const Mention = styled($Member)<Props & Record<string, unknown>>`
  ${({ theme, color, inline }) =>
    base(inline, color || theme.colors.accent, false)};
`;

export const Channel = styled($Channel)<Props & Record<string, unknown>>`
...
export const Role = styled($Role)<RoleProps & Record<string, unknown>>`
  ${({ theme, color, inline }) =>
    base(inline, color || theme.colors.accent, false)};
`;
